...
# primed data file
# PRIMED_DATA_FILE = "data/primed_created-1.json" # curated smaller list
PRIMED_DATA_FILE = "data/primed_created_merged.json"
# PRIMED_DATA_FILE = "data/primer_data_summarized_full.json"  # FULL corpus summarized
